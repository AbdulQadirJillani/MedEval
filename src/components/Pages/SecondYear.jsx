...
export default function SecondYear(props) {
  return (
    ...
    <div className={`${styles.modulewrapper} ${styles.neuroscience}`}>
        ...
        <Link onClick={()=>props.update('2nd-year', 'neuroscience', null)} className={styles.link} to='neuroscience/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.headneck}`}>
        ...
        <Link onClick={()=>props.update('2nd-year', 'head-and-neck', null)} className={styles.link} to='head-and-neck/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.endocrinology}`}>
        ...
        <Link onClick={()=>props.update('2nd-year', 'endocrinology', null)} className={styles.link} to='endocrinology/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.gastrointestinal}`}>
        ...
        <Link onClick={()=>props.update('2nd-year', 'gastrointestinal', null)} className={styles.link} to='gastrointestinal/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.renal}`}>
        ...
        <Link onClick={()=>props.update('2nd-year', 'renal', null)} className={styles.link} to='renal/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.reproductive}`}>
        ...
        <Link onClick={()=>props.update('2nd-year', 'reproductive', null)} className={styles.link} to='reproductive/compiled'>compiled</Link>
      </div>
    </div>
    </>
  )
