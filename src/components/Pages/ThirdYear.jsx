  ...
  return (
    ...
    <div className={`${styles.modulewrapper} ${styles.foundation}`}>
      ...
      <div className={`${styles.modulewrapper} ${styles.infectious}`}>
        ...
        <Link onClick={()=>props.update('3rd-year', 'infectious', null)} className={styles.link} to='infectious/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.blood}`}>
        ...
        <Link onClick={()=>props.update('3rd-year', 'hematology', null)} className={styles.link} to='hematology/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.respiratory}`}>
        ...
        <Link onClick={()=>props.update('3rd-year', 'respiratory', null)} className={styles.link} to='respiratory/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.cardiovascular}`}>
        ...
        <Link onClick={()=>props.update('3rd-year', 'cardiovascular', null)} className={styles.link} to='cardiovascular/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.gastrointestinal}`}>
        ...
        <Link onClick={()=>props.update('3rd-year', 'gastrointestinal', null)} className={styles.link} to='gastrointestinal/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.renal}`}>
        ...
        <Link onClick={()=>props.update('3rd-year', 'renal', null)} className={styles.link} to='renal/compiled'>compiled</Link>
      </div>
      ...
      <div className={`${styles.modulewrapper} ${styles.endocrinology}`}>
        ...
        <Link onClick={()=>props.update('3rd-year', 'endocrinology', null)} className={styles.link} to='endocrinology/compiled'>compiled</Link>
      </div>
    </div>
    </>
  )
